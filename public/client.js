...
function displayData(arr1, obj2, obj3, obj4, obj5) {
  ...
  $.each(arr1, function(key, value) {
    ...
    if (OI1["timeSpan"] <= 7 || OI5["timeSpan"] <= 7) {
      ...
      newHTML += `<td class="tg-6k2t" style="background-color:rgb(${200-(item5.redditPosts*4)}, ${100+(item5.redditPosts*4)}, ${255-(item5.redditPosts*4)})">${item5.redditPosts}</td>`;      
      ...
      newHTML += `<td class="tg-6k2t" style="background-color:rgb(${150-red54*10}, ${100+red54*10}, ${150+red54*10})">${red54}</td>`;      
      ...
      newHTML += `<td class="tg-6k2t" style="background-color:rgb(${150-red43*10}, ${100+red43*10}, ${150+red43*10})">${red43}</td>`;      
      ...
      newHTML += `<td class="tg-6k2t" style="background-color:rgb(${150-red32*10}, ${100+red32*10}, ${150+red32*10})">${red32}</td>`;      
      ...
      newHTML += `<td class="tg-6k2t" style="background-color:rgb(${150-red21*10}, ${100+red21*200}, ${150+red21*10})">${red21}</td>`;      
